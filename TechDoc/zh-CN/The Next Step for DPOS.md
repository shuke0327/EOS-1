...
当人们指出矿池的中心化时，POW 拥护者会反驳称: *"由于矿工可以随时切换矿池，所以这并没有那么糟糕。“* 这说法当然正确。如果矿池做了坏事，矿工只要选择其它矿池，它会很快失去大量的hash算力。
...
The first layer of the blockchain decentralization is the BPs. The second layer should be different tasks of a BP. Blockchain 去中心化的第一层是 BP。第二层应该是一个 BP 节点的不同任务。
